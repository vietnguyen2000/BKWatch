<div class="row">
  <div class="col-6 text-success" style="display: flex; align-items: center; justify-content: center; border-right: 1px solid rgba(128, 128, 128, 0.25);">
  ...
  <div class="col-6 text-success" style="display: flex; align-items: center; justify-content: center;">
